...
INSERT INTO `countries` (`country_code`, `iso_code`, `country_name`, `currency_code`, `continent_code`, `population`, `are_in_sq_km`, `capital`) VALUES
	...
	('AX', 'ALA', 'Г…land', 'EUR', 'EU', 26711, 1580, 'Mariehamn'),
	...
	('BL', 'BLM', 'Saint BarthГ©lemy', 'EUR', 'NA', 8450, 21, 'Gustavia'),
	...
	('BR', 'BRA', 'Brazil', 'BRL', 'SA', 201103330, 8511965, 'BrasГ­lia'),
	...
	('CM', 'CMR', 'Cameroon', 'XAF', 'AF', 19294149, 475440, 'YaoundГ©'),
	('CN', 'CHN', 'China', 'CNY', 'AS', 1330044000, 9596960, 'Beijing'),
	('CO', 'COL', 'Colombia', 'COP', 'SA', 47790000, 1138910, 'BogotГЎ'),
	('CR', 'CRI', 'Costa Rica', 'CRC', 'NA', 4516220, 51100, 'San JosГ©'),
	...
	('EH', 'ESH', 'Western Sahara', 'MAD', 'AF', 273008, 266000, 'El AaiГєn'),
	...
	('FO', 'FRO', 'Faroe Islands', 'DKK', 'EU', 48228, 1399, 'TГіrshavn'),
	...
	('GU', 'GUM', 'Guam', 'USD', 'OC', 159358, 549, 'HagГҐtГ±a'),
	...
	('MV', 'MDV', 'Maldives', 'MVR', 'AS', 395650, 300, 'MalГ©'),
	...
	('PY', 'PRY', 'Paraguay', 'PYG', 'SA', 6375830, 406750, 'AsunciГіn'),
	('QA', 'QAT', 'Qatar', 'QAR', 'AS', 840926, 11437, 'Doha'),
	('RE', 'REU', 'RГ©union', 'EUR', 'AF', 776948, 2517, 'Saint-Denis'),
	...
	('ST', 'STP', 'SГЈo TomГ© and PrГ­ncipe', 'STD', 'AF', 175808, 1001, 'SГЈo TomГ©'),
	...
	('TF', 'ATF', 'French Southern Territories', 'EUR', 'AN', 140, 7829, 'Port-aux-FranГ§ais'),
	('TG', 'TGO', 'Togo', 'XOF', 'AF', 6587239, 56785, 'LomГ©'),
...
INSERT INTO `currencies` (`currency_code`, `description`) VALUES
	...
	('VUV', 'Vanuatu Vatu'),
	('WST', 'Samoa Tala'),
	('XAF', 'CommunautГ© FinanciГЁre Africaine (BEAC) CFA Franc BEAC'),
	('XCD', 'East Caribbean Dollar'),
	('XDR', 'International Monetary Fund (IMF) Special Drawing Rights'),
	('XOF', 'CommunautГ© FinanciГЁre Africaine (BCEAO) Franc'),
	('XPF', 'Comptoirs FranГ§ais du Pacifique (CFP) Franc'),
	('YER', 'Yemen Rial'),
...
INSERT INTO `rivers` (`id`, `river_name`, `length`, `drainage_area`, `average_discharge`, `outflow`) VALUES
	...
	(8, 'ParanГЎ', 4880, 2582672, 18000, 'RГ­o de la Plata'),
	...
	(20, 'PurГєs', 3211, 63166, 8400, 'Amazon'),
	(21, 'Yukon', 3185, 850000, 6210, 'Bering Sea'),
	(22, 'Indus', 3180, 960000, 7160, 'Arabian Sea'),
	(23, 'SГЈo Francisco', 3180, 610000, 3300, 'Atlantic Ocean'),
