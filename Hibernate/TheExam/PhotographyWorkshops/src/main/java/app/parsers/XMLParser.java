...
public class XMLParser implements FileParser {
    ...
    @Override
    public <T> T read(Class<T> objectClass, String filePath) throws IOException, JAXBException {
    ...
    @Override
    public <T> void write(T object, String filePath) throws IOException, JAXBException {
